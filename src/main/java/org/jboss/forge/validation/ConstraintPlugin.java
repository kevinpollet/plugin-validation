...
public class ConstraintPlugin implements Plugin
{
    ...
    @Command(value = "Valid")
    public void addValidConstraint(@Option(name = "onProperty", completer = PropertyCompleter.class) String property) throws FileNotFoundException
    {
        ...
        outputConstraintAdded(Valid.class);
    }

    @Command(value = "Null")
    public void addNullConstraint(@Option(name = "onProperty", completer = PropertyCompleter.class) String property,
                                  @Option(name = "message") String message) throws FileNotFoundException
    {
        ...
        outputConstraintAdded(Null.class);
    }

    @Command(value = "NotNull")
    public void addNotNullConstraint(@Option(name = "onProperty", completer = PropertyCompleter.class) String property,
                                     @Option(name = "message") String message) throws FileNotFoundException
    {
        ...
        outputConstraintAdded(NotNull.class);
    }

    @Command(value = "AssertTrue")
    public void addAssertTrueConstraint(@Option(name = "onProperty", completer = PropertyCompleter.class) String property,
                                        @Option(name = "message") String message) throws FileNotFoundException
    {
        ...
        outputConstraintAdded(AssertTrue.class);
    }

    @Command(value = "AssertFalse")
    public void addAssertFalseConstraint(@Option(name = "onProperty", completer = PropertyCompleter.class) String property,
                                         @Option(name = "message") String message) throws FileNotFoundException
    {
        ...
        outputConstraintAdded(AssertFalse.class);
    }

    @Command(value = "Min")
    public void addMinConstraint(@Option(name = "onProperty", completer = PropertyCompleter.class) String property,
                                 ...
                                 @Option(name = "message") String message) throws FileNotFoundException
    {
        ...
        outputConstraintAdded(Min.class);
    }

    @Command(value = "Max")
    public void addMaxConstraint(@Option(name = "onProperty", completer = PropertyCompleter.class) String property,
                                 ...
                                 @Option(name = "message") String message) throws FileNotFoundException
    {
        ...
        outputConstraintAdded(Max.class);
    }


    @Command(value = "DecimalMin")
    public void addDecimalMinConstraint(@Option(name = "onProperty", completer = PropertyCompleter.class) String property,
                                        ...
                                        @Option(name = "message") String message) throws FileNotFoundException
    {
        ...
        outputConstraintAdded(DecimalMin.class);
    }

    @Command(value = "DecimalMax")
    public void addDecimalMaxConstraint(@Option(name = "onProperty", completer = PropertyCompleter.class) String property,
                                        ...
                                        @Option(name = "message") String message) throws FileNotFoundException
    {
        ...
        outputConstraintAdded(DecimalMax.class);
    }

    @Command(value = "Size")
    public void addSizeConstraint(@Option(name = "onProperty", completer = PropertyCompleter.class) String property,
                                  ...
                                  @Option(name = "message") String message) throws FileNotFoundException
    {
        ...
        outputConstraintAdded(Size.class);
    }

    @Command(value = "Digits")
    public void addDigitsConstraint(@Option(name = "onProperty", completer = PropertyCompleter.class) String property,
                                    ...
                                    @Option(name = "message") String message) throws FileNotFoundException
    {
        ...
        outputConstraintAdded(Digits.class);
    }

    @Command(value = "Past")
    public void addPastConstraint(@Option(name = "onProperty", completer = PropertyCompleter.class) String property,
                                  @Option(name = "message") String message) throws FileNotFoundException
    {
        ...
        outputConstraintAdded(Past.class);
    }

    @Command(value = "Future")
    public void addFutureConstraint(@Option(name = "onProperty", completer = PropertyCompleter.class) String property,
                                    @Option(name = "message") String message) throws FileNotFoundException
    {
        ...
        outputConstraintAdded(Future.class);
    }

    @Command(value = "Pattern")
    public void addPatternConstraint(@Option(name = "onProperty", completer = PropertyCompleter.class) String property,
                                     ...
                                     @Option(name = "message") String message) throws FileNotFoundException
    {
        ...
        outputConstraintAdded(Pattern.class);
    }
    ...
    private void outputConstraintAdded(Class<? extends java.lang.annotation.Annotation> constraintClass)
    {
        shell.println("Constraint " + constraintClass.getSimpleName() + " has been successfully added.");
    }
}
